...
described in Section \ref{framework}. Section \ref{results} showcases
obtained results for the robot HRP-2. We also show an extension to
multiple contact points in Section
