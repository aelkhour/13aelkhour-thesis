...
\equref{eq:chap3-hjb} is the PDE which gives the necessary and sufficient
...
We saw in Equation \equref{eq:chap3-dynamic-balance-inverse} that if we
...
from Equation \equref{eq:chap3-friction-cone} also need to be taken into
account.
