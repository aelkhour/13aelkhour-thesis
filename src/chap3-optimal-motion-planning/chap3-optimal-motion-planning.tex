...
\begin{figure}
  ...
  \end{subfigure}
  \caption{FIXME Martial arts scenario, phase 2: trajectories of the ZMP and
...
\begin{figure}
  ...
  \end{subfigure}
  \caption{FIXME Martial arts scenario, phase 2: .}
...
first part limited to coplanar contact points, second part formulation
allows optimization for non-coplanar contact points. But we still need
to plan statically balanced paths see \cite{bretl2006motion}.

\paragraph{Towards collision-free walking optimization}
...
phases, as it is the case in \cite{lengagne2011generation}. Another
solution: reformulate problem to take into account changing contacts
through a linear complementarity constraint between a contact point
distance to the obstacles and the contact normal reaction force, such
as in \cite{posa2012direct, tassa2012synthesis}. Use small-space for
planning phase, nicolas perrin?
