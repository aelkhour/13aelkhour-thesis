...
using the Rosenbrock function \ref{rosenbrock1960automatic}, or banana
function, defined as:
...
\emph{Hamilton-Jacobi-Bellman (HJB) Partial Differential Equation (PDE)}:
