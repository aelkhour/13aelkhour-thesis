...
\begin{figure}
  \centering
      ...
      \caption[Illustration of the optimal control
        problem.]{Illustration of the optimal control problem, showing
...
\equref{eq:chap3-hjb} is the PDE which gives the necessary conditions
...
\begin{figure}
  \centering
      ...
      \caption[Solving the OCP with direct single-shooting
        methods.]{Solving the OCP with direct single-shooting methods:
...
\begin{figure}
  \centering
      ...
      \caption[Solving the OCP with direct multiple-shooting
        methods.]{Solving the OCP with direct multiple-shooting
        methods: controls are discretized on a coarse grid, and
        several initial values for the state are given. The state
        trajectory is computed on each sub-interval by numerical
        integration of the model ODE starting from the node
        values. Note that the whole trajectory is not continuous, and
        additional continuity constraints need to be added.}
...
\begin{figure}
  \centering
      ...
      \caption[Contact forces are applied on the anthropomorphic
        system.]{Non-vanishing and non-sliding contact forces are
...
\begin{figure}
  \centering
      ...
      \caption[Possible self-collision pairs for a robot body.]{All
        self-collision possible pairs are shown in red for body
        $B_i$. The collision pair between $B_i$ and an obstacle $O$ is
        also shown in blue.}
...
\begin{figure}
  ...
  \begin{subfigure}{0.24\columnwidth}
    ...
    \caption[Original geometries.]{Original geometries.}
    \label{simple-patha}
  \end{subfigure}
  \begin{subfigure}{0.24\columnwidth}
    \centering
    ...
    \caption[Convex hull.]{Convex hull.}
  ...
  \begin{subfigure}{0.24\columnwidth}
    ...
    \caption[Initial capsule parameter guess.]{Initial capsule parameter guess.}
    \label{capsulea}
  \end{subfigure}
  \begin{subfigure}{0.24\columnwidth}
    \centering
    ...
    \caption[Optimization result.]{Optimization result.}
    \label{simple-path-sol-shortcuta}
  \end{subfigure}
  \caption[Minimum-volume bounding capsules generation for the
    HRP-2.]{Minimum-volume bounding capsule generation for the HRP-2.}
...
\caption[Path found by the path planner in a shelves
  environment.]{Path found by the path planner in a shelves
  environment.}
\label{path}
\end{figure}
...
\begin{figure}
  ...
  \end{subfigure}
  \caption[Initial trajectory parametrization.]{In this example, the
    planned path contains 5 milestones. The jerk (in orange) is a
    continuous piecewise linear function, and is computed such that
    the position trajectory starts and ends with zero velocity and
    acceleration at each milestone. The state nodes (blue dots) are
    similarly chosen, and the controls are integrated over each
    sub-interval to obtain the full trajectory (in blue). Note that
    discontinuities are observed because of the control
    parameterization.}
...
\begin{figure}
  ...
  \end{subfigure}
  \caption[Paths for the test case.]{Paths for the test case.}
\end{figure}
...
\begin{figure}
  ...
  \end{subfigure}
  \caption[Test case: optimized trajectories for the chest yaw
    joint.]{Test case: optimized position, velocity, acceleration and
...
\begin{figure}
  ...
  \caption[Test case: evolution of kinematic constraint values over
    time.]{Test case: evolution of kinematic constraint values over
...
\begin{figure}
  ...
  \caption[Test case: Evolution of the distance inequality constraint
    values.]{Test case: Evolution of the distance inequality
    constraint values over time. As the constraints are only enforced
    at the shooting nodes, a slight penetration of a maximum of 1mm is
...
\begin{figure}
  ...
  \caption[Test case: Trajectory of the ZMP and the CoM
    projection.]{Test case: Trajectory of the ZMP and the CoM vertical
...
\begin{figure}
  ...
  \caption[Martial arts scenario: evolution of the distance
    constraints.]{Martial arts scenario, phase 2: evolution
    of the distance inequality constraint values over time. A slight
    penetration of a maximum of 3mm is observed between the left and
    right forearm capsules.}
...
\begin{figure}
  ...
  \caption[Martial arts scenario: trajectory of the ZMP and the CoM
    projection.]{Martial arts scenario, phase 2: trajectory of the ZMP
    and the CoM vertical projection on the floor. The green rectangles
...
\begin{figure}
  ...
  \end{subfigure}
  \caption[Shelves scenario: trajectories of the ZMP and the CoM
    projection.]{Shelves scenario, phase 2: trajectories of the ZMP
    and the CoM vertical projection on the floor. Left: the dynamic
...
\begin{figure}
  ...
  \caption[Shelves scenario: evolution of the distance
    constraints.]{Shelves scenario, phase 2: evolution of the distance
...
\begin{figure}
  ...
  \caption[HRP-2 does a quick martial arts motion while avoiding
    self-collision.]{HRP-2 does a quick martial arts motion while
...
\begin{figure}
  ...
  \begin{subfigure}{0.19\columnwidth}
    ...
    \label{shelves-10}
  \end{subfigure}
  \caption[HRP-2 transfers quickly a ball in a shelf.]{HRP-2 bends down
    quickly to grab a ball in the lower shelf and transfers it to the
    upper shelf.}
  \label{shelves}
\end{figure}
...
\begin{figure}
  ...
  \end{subfigure}
  \caption[Martial arts scenario: trajectories of the ZMP and the
    CoP.]{Martial arts scenario, phase 2: trajectories of the ZMP and
...
\begin{figure}
  ...
  \end{subfigure}
  \caption[Martial arts scenario: Left and right normal contact
    forces.]{Martial arts scenario, phase 2: Left and right normal
...
\begin{figure}
  ...
  \caption[Martial arts scenario: floating joint generalized torque
    evolution.]{Martial arts scenario, phase 2: floating joint
    generalized torque evolution over time. It is required to be equal
    to 0 in order to obtain dynamic balance.}
...
\begin{figure}
  ...
  \caption[Martial arts scenario: collision avoidance constraints
    evolution.]{Martial arts scenario, phase 2: collision avoidance
