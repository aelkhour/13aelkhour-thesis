...
where $m_i$ and $\mathbf{x}_i$ are respectively the mass and center of
mass vector of rigid body \body{i}, $\mathbf{g}$ is the gravity
...
Equation \equref{eq:chap1-dynamic-balance} coincides with the CoM. This
...
lead to an trajectory which is not time-optimal. For instance, the
