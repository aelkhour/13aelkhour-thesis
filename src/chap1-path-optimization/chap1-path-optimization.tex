...
smooth a path. It first tries to connect directly \config{s} to
...
are capable of accomplishing human-like tasks: locomotion -- e.g
walking, running and parkour -- manipulation, or both. Due to these
tasks complexity, anthropomorphic systems are both underactuated and
highly-redundant systems.

In the remainder of this work, we will refer indifferently to
...
Robots \robot are usually composed of a set of rigid bodies \body{i},
...
system, and not only its actuators. Hence, anthropomorphic systems are
said to be unactuated systems.
...
``waist'' of the robot. Hence, a full configuration \config{} of the
...
\begin{figure}
  \centering
      ...
      \caption{Anthropomorphic systems are highly-redundant
        ...
        effector \body{r}, there exists more than one configuration
...
tasks. This will be discussed in more deeply in Chapter
\ref{chap2-FIXME}.
...
forbidden, i.e. the human's direction is always tangent to its path.
...
Discussion about drawback, possible improvements.
